...
namespace motioncam {
    ...
    void Decoder::loadFrameRaw(const Timestamp timestamp,
                               ...
                               std::string& outFrameMetadataJson)
    {
        ...
        outCompressedBuffer.resize(bufferItem.size);
        read(outCompressedBuffer.data(), bufferItem.size);
        ...
        outFrameMetadataJson.resize(metadataItem.size);
        read(outFrameMetadataJson.data(), metadataItem.size);
    }
